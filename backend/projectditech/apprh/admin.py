...
class EmployeeAdmin(admin.ModelAdmin):
    list_display = ['employee_id', 'full_name', 'position', 'service', 'salary', 'is_active', 'date_of_hire']
    list_filter = ['service', 'is_active', 'position', 'date_of_hire']
    search_fields = ['employee_id', 'first_name', 'last_name', 'email', 'phone']
    readonly_fields = ['employee_id', 'created_at', 'updated_at']
    fieldsets = (
        ('Informations personnelles', {
            'fields': ('user', 'employee_id', 'first_name', 'last_name', 'email', 'phone', 'address', 'date_of_birth', 'photo', 'badge_id')
        }),
        ('Informations professionnelles', {
            'fields': ('position', 'service', 'date_of_hire', 'salary', 'is_active')
        }),
        ('Dates', {
