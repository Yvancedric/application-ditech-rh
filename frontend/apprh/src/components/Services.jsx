...
const Services = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Ne pas inclure manager si vide, sinon convertir en entier
      ...
      if (editingService) {
        await api.put(`/ditech/services/${editingService.id}/`, dataToSend)
      ...
      console.error('Données envoyées:', { name: formData.name, description: formData.description, manager: formData.manager })
      const errorMessage = err.response?.data?.detail || 
                          err.response?.data?.message || 
  ...
  const handleDelete = async () => {
    try {
      await api.delete(`/ditech/services/${deleteConfirm.id}/`)
